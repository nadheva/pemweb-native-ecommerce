...
<body>
	...
	<nav class="navbar navbar-expand-md bg-dark navbar-dark">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" href="index2.php?target=home">Beranda</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index2.php?target=produk">Produk</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index2.php?target=keranjang">Keranjang</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index2.php?target=checkout">Checkout</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index2.php?target=nota">Nota</a>
				</li>
				<!-- <li class="nav-item">
